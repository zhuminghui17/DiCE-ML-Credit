...
def get_room_and_payment_details():
    ...
    return reserved_room_type, deposit_type, adr, required_car_parking_spaces, total_of_special_requests, customer_type
...
def user_input():
    ...
    reserved_room_type, deposit_type, adr, required_car_parking_spaces, total_of_special_requests, customer_type = get_room_and_payment_details()
    lead_time, arrival_date_month, arrival_date_week_number, arrival_date_day_of_month, stays_in_weekend_nights, stays_in_week_nights = calculate_booking_details(booking_date, date_reserved)
